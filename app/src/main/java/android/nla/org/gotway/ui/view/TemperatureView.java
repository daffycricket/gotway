...
public class TemperatureView
    ...
    private void drawBg(Canvas paramCanvas) {
        ...
        for (; ; ) {
            if (i >= 5) {
                ...
                i = paramCanvas.saveLayer(0.0F, 0.0F, this.w, this.h, this.mBgPaint, Canvas.ALL_SAVE_FLAG);
    ...
    private void init() {
        ...
        this.mTemperPaint.setColor(Color.RED);
    ...
    private void initGradient() {
        ...
        float f3 = this.mSmallRadius;
        int[] localObject = new int[3];
        localObject[2] = i;
        Shader.TileMode localTileMode = Shader.TileMode.CLAMP;
        this.mRadialGradientSmall = new RadialGradient(f1, f2, f3 * 0.8F, localObject, new float[]{0.0F, 0.08F, 1.0F}, localTileMode);
        f1 = this.mCenterX;
        f2 = this.mCenterY;
        f3 = this.mRadius;
        localObject = new int[3];
        localObject[2] = i;
        // TODO Il ne manque pas localObject[0] et localObject[1] ?
        localTileMode = Shader.TileMode.CLAMP;
        this.mRadialGradientBig = new RadialGradient(f1, f2, f3, localObject, new float[]{0.2F, 0.3F, 1.0F}, localTileMode);
        f1 = this.mCenterX;
        f2 = this.mSmallRadius;
        f3 = this.mCenterX;
        float f4 = this.mSmallRadius;
        localObject = new int[3];
        // TODO Il ne manque pas localObject[1] ?
        localObject[0] = i;
        localObject[2] = i;
        this.mLinearGradient = new LinearGradient(f1 - f2 * 0.8F, 0.0F, f4 * 0.8F + f3, 0.0F, localObject, null, Shader.TileMode.CLAMP);
        f1 = this.mCenterY;
        f2 = this.mRadius;
        f3 = this.mTemperTop;
        Shader.TileMode titleMode = Shader.TileMode.CLAMP;
        this.mTemperGradient = new LinearGradient(0.0F, f2 + f1, 0.0F, f3, new int[]{-16698673, -14288878, -65536}, null, titleMode);
