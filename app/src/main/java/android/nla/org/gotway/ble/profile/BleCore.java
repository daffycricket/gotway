...
import com.reb.hola.ble.DataPraser;
import com.reb.hola.ble.Util;
...
public class BleCore
{
  ...
  private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback()
  {
    public void onCharacteristicChanged(BluetoothGatt paramAnonymousBluetoothGatt, BluetoothGattCharacteristic paramAnonymousBluetoothGattCharacteristic)
    {
      ...
      DataPraser.praser(BleCore.this.mCallbacks, paramAnonymousBluetoothGatt);
    }
    ...
    {
      paramAnonymousBluetoothGatt = new StringBuilder("onCharacteristicWrite---->").append(paramAnonymousBluetoothGattCharacteristic.getUuid().equals(BleCore.CHARACTER_UUID)).append("******");
      ...
      for (boolean bool = true;; bool = false)
      {
        ...
        {
          paramAnonymousBluetoothGatt = paramAnonymousBluetoothGattCharacteristic.getValue();
          String str = Util.bytes2HexStr(paramAnonymousBluetoothGatt);
          DebugLogger.e("BleManager", "write:" + str);
          if ((paramAnonymousBluetoothGattCharacteristic.getUuid().equals(BleCore.CHARACTER_UUID)) && (Arrays.equals(paramAnonymousBluetoothGatt, BleCore.this.mLastWriteData)) && (BleCore.this.mCallbacks != null))
          {
            DebugLogger.e("BleManager", "write:" + str);
  ...
  public boolean connect(Context paramContext, String paramString)
  {
    ...
    {
      BluetoothAdapter localBluetoothAdapter = ((BluetoothManager)paramContext.getSystemService("bluetooth")).getAdapter();
      if (localBluetoothAdapter != null)
      {
        paramString = localBluetoothAdapter.getRemoteDevice(paramString);
        if (paramString != null) {
          return connect(paramContext, paramString);
        }
      }
    }
    return false;
...
/* Location:              C:\tmp\dex2jar-2.0\classes-dex2jar.jar!\com\reb\hola\ble\profile\BleCore.class
